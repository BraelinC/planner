                  ...
                  >
                    ...
                    {dayEvents.map((event) => {
                      ...
                      return (
                        <div
                          key={event._id}
                          className="absolute left-0.5 right-0.5 md:left-1 md:right-1 rounded-md overflow-hidden text-white cursor-pointer hover:brightness-110 transition-all shadow-md border-l-4"
                          style={{
                            top,
